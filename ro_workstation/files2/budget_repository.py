...
class BudgetRepository:
    def __init__(self) -> None:
        ...
        self.param_map = {
            "TOTAL ADVANCES": "Adv",
            "TOTAL DEPOSITS": "Tot_Dep",   # FIXED: was "TD" — Total Deposits != Term Deposit
            "CASA": "CASA",                # CASA = SB + CD
            "NPA": "NPA",
            "SB": "SB",
            "CD": "CD",
            "TD": "TD",                    # ADDED: TD = Term Deposit budget code
            "RET TD": "Ret_TD",            # Ret TD = TD minus Bulk Deposits
            "ADV": "Adv",
            "BUS": "Bus",
            "CORE AGRI": "Core_Agri",
            "AGRI JL": "Agri_JL",
